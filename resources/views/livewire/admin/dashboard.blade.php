...
<div>
    <div class="container mx-auto mt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="{{ route('admin.agency.dashboard') }}" class="block p-6 bg-blue-500 text-white rounded-lg shadow hover:bg-blue-600">
                <h2 class="text-xl font-bold">{{ __('Agency Dashboard') }}</h2>
