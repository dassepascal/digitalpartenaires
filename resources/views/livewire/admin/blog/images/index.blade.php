...
{
    // Créer un répertoire par défaut si nécessaire
    $currentYear = date('Y'); // Par exemple, "2025"
    if (!Storage::exists('public/photos/' . $currentYear)) {
        Storage::makeDirectory('public/photos/' . $currentYear);
        Storage::makeDirectory('public/photos/' . $currentYear . '/01'); // Mois par défaut
    }
   ...
   // dd($this->months);
    ...
    {
        //dd(Storage::exists("public/photos/{$this->selectedYear}"));
