...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/pascal/Documents/informatique/sites/DigitalPartenaire/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/pascal/Documents/informatique/sites/DigitalPartenaire/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'broadcasting.connections.null.driver','concurrency.default','debugbar.enabled','debugbar.hide_empty_tabs','debugbar.except',
...
'livewire.pagination_theme','mary.prefix','mary.route_prefix','mary.components.spotlight.class','ide-helper.filename',
...
'livewire.preview-file','mary.toogle-sidebar','mary.spotlight','mary.upload','login','password.reset',
'admin','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.admin','components.layouts.app','components.session-status','livewire.admin.index','livewire.admin.sidebar',
'livewire.auth.forgot-password','livewire.auth.login','livewire.auth.register','livewire.auth.reset-password','livewire.index',
'livewire.navigation.footer','livewire.navigation.navbar','livewire.navigation.sidebar','mails.registered','volt-livewire::admin.index',
'volt-livewire::admin.sidebar','volt-livewire::auth.forgot-password','volt-livewire::auth.login','volt-livewire::auth.register','volt-livewire::auth.reset-password',
'volt-livewire::index','volt-livewire::navigation.footer','volt-livewire::navigation.navbar','volt-livewire::navigation.sidebar','laravel-exceptions-renderer::components.card',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.address','validation.attributes.affiliate_url','validation.attributes.age',
...
'validation.attributes.work','validation.attributes.year','en.0','actions.accept','actions.action',
